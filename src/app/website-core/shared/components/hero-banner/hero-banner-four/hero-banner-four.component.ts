...
public slider_nav_data = [
  { icon: "/assets/website/img/slider/4/nav/icon-1.png", title: "Ring <br />& Earring" },
  { icon: "/assets/website/img/slider/4/nav/icon-2.png", title: "Bangles & <br />Bracelets" },
  { icon: "/assets/website/img/slider/4/nav/icon-3.png", title: "Drop <br /> Necklaces" },
  { icon: "/assets/website/img/slider/4/nav/icon-4.png", title: "Diamond <br /> Necklaces" }
];
